              ...
              {appointment.status === "active" && (
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1 bg-green-500 hover:bg-green-600 text-white rounded-lg py-2 text-sm transition"
                  >
                    <CheckCircle size={16} />
                    Approve
                  </button>
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1 bg-red-500 hover:bg-red-600 text-white rounded-lg py-2 text-sm transition"
                  >
                    <X size={16} />
                    Reject
                  </button>
