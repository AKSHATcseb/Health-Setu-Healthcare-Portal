...
export default function HospitalLocationForm({
  formData,
  setFormData,
  errors,
  setErrors,
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            <textarea
              placeholder="Enter complete hospital address (street, city, state, postal code)"
        ...
        <div className="bg-blue-50 rounded-lg p-4 border-2 border-blue-200">
          <div className="flex items-start gap-3 mb-3">
            ...
            <p className="text-xs text-blue-700 font-medium">
              Use your device's location to get GPS coordinates
            </p>
          </div>
          <button
        ...
        {formData.latitude && formData.longitude && (
          <div className="bg-green-50 rounded-lg p-3 border-2 border-green-200 flex items-start gap-2">
            <span className="text-green-600 mt-0.5">✓</span>
            <div>
              <p className="text-xs text-green-700 font-semibold">Location Detected</p>
